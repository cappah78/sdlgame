...
#ifdef _DEBUG
#define glqCheckGLError() { __glqCheckGLError(__FILE__, __LINE__); }
#else // !_DEBUG
#define glqCheckGLError() {  }
#endif // _DEBUG
...
void glqUnmapBuffer(GLenum target, GLboolean& out);
...
void glqIsBuffer(GLuint& buffer, GLboolean& out);
...
void glqIsVertexArray(GLuint& arr, GLboolean& out);
...
/* Shader and Programs */
// Shader Objects
void glqCreateShader(GLenum type, GLuint& out);
...
// Program Objects
void glqCreateProgram(GLuint& out);
...
void glqGetAttribLocation(GLuint& program, const GLchar* name, GLint& out);
void glqBindAttribLocation(GLuint& program, GLuint& index, const GLchar* name);
// Uniform variables
void glqGetUniformLocation(GLuint& program, const GLchar* name, GLint& out);
void glqGetUniformBlockIndex(GLuint& program, const GLchar* uniformBlockName, GLuint& out);
...
void glqGetFragDataLocation(GLuint& program, const GLchar* name, GLint& out);

/* Shader Queries */
void glqIsShader(GLuint& shader, GLboolean& out);
...
void glqIsProgram(GLuint& program, GLboolean& out);
...
void glqClearColor2(GLclampf& r, GLclampf g, GLclampf& b, GLclampf& a);
...
void glqFlush();
void glqFinish();
void glqFenceSync(GLenum condition, GLbitfield flags, GLsync& out);
void glqDeleteSync(GLsync& sync);
void glqClientWaitSync(GLsync& sync, GLbitfield flags, GLuint64 timeout_ns, GLenum& out);
...
void glqIsSync(GLsync& sync, GLboolean& out);