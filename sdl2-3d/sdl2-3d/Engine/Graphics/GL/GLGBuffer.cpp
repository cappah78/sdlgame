...
GLGBuffer::GLGBuffer(unsigned int numTextures, unsigned int width, unsigned int height)
...
bool GLGBuffer::init(unsigned int width, unsigned int height)
{
	/*
	// Create the FBO
...
void GLGBuffer::bindForWriting()
{
	glBindFramebuffer(GL_DRAW_FRAMEBUFFER, m_fbo);
}

void GLGBuffer::bindForReading(unsigned int fromTextureUnit)
{
...
void GLGBuffer::bindDepthTexture(unsigned int textureUnit)
{
...
void GLGBuffer::setReadBuffer(unsigned int textureIdx)
{
	glBindFramebuffer(GL_READ_FRAMEBUFFER, m_fbo);
