...
std::auto_ptr<IVertexBuffer> GLGraphicsProvider::createVertexBuffer(IShader* shader, unsigned int bufferIndex, const char* bufferName, const IVertexBufferParameters& parameters)
{
