...
public:
	...
	virtual std::auto_ptr<IVertexBuffer> createVertexBuffer(IShader* shader, unsigned int bufferIndex, const char* bufferName, const IVertexBufferParameters& parameters) = 0;
