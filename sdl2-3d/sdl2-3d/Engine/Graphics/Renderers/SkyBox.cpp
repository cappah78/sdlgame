...
SkyBox::SkyBox()
	: m_mesh("Assets/Models/Skybox/box.obj")	//relative from Mesh.cpp
	, m_cubeMap(&textureNames[0])
{
	m_skyBoxShader = ShaderManager::createShaderProgram("Assets/Shaders/skybox.vert", 0, "Assets/Shaders/skybox.frag");
